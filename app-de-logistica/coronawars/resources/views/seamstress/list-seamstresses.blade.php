                          ...
                          <tr>
                              <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                  <a onclick="return confirm('{{__('Are you sure?')}}');" href="{{route('delete-seamstress',['id'=>$seamstress->id])}}" class="btn btn-danger" title="{{__('Delete')}}"><i class="fa fa-trash"></i></a>
                                  <a href="{{route('get-seamstress',['seamstress_id'=>$seamstress->id])}}" class="btn btn-light" title="{{__('Edit')}}"><i class="fa fa-pencil"></i></a>
                                </div>
                              </td>
